package nl.saxion.playground.switchRun.lib;
...
public class GameModel implements Serializable {
    ...
    // Guus Geurkink: I added a tick function because I think updating the entities is perfectly
    // suited for GameModel because it also stores the entities. I need this extra control
    // to make sure that everything is updated in the proper order. Collision detection,
    // for example, needs to happen after all entities are updated.
    public void tick() {
